...
2. `aseg` - Automatic sub-cortical segmentation.  
...
p <- p |> 
  plotly::add_annotations( text="Screen capture",
                  ...
                  font = list(color = 'darkgrey',
                              family = 'sans serif',
                              size = 50)) 
plotly::orca(p, "man/figures/README-dk-plot.png")
knitr::include_graphics("man/figures/README-dk-plot.png")
```
...
p <- p |>
  plotly::add_annotations(
    ...
    legendtitle = TRUE,
    showarrow = FALSE,
    font = list(color = 'darkgrey', family = 'sans serif', size = 50)
  )
plotly::orca(p, "man/figures/README-aseg-plot.png")
knitr::include_graphics("man/figures/README-aseg-plot.png")
```
