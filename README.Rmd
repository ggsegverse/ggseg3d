...
p <- p |> 
  plotly::add_annotations( text="Screen capture",
                  ...
                  font = list(color = 'darkgrey',
                              family = 'sans serif',
                              size = 50)) 
plotly::orca(p, "man/img/README-dk-plot.png")
knitr::include_graphics("man/img/README-dk-plot.png")
```
...
plotly::orca(p, "man/img/README-aseg-plot.png")
knitr::include_graphics("man/img/README-aseg-plot.png")
```
